...
const GuestSelector: React.FC<GuestSelectorProps> = ({
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {open && (
        <div className="absolute z-50 mt-2 bg-white shadow-lg rounded-xl p-4 w-72 transition-colors">
          {/* Adults */}
          <div className="flex justify-between items-center border-b border-gray-200 py-2">
            <div>
              <p className="font-medium transition-colors">{t('adultLabel')}</p>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="transition-colors">{adults}</span>
              <button
                onClick={() => updateGuests("adults", 1)}
                className="w-8 h-8 rounded-full border border-gray-300 text-lg flex items-center justify-center  hover:bg-gray-100 transition-colors"
              >
          ...
          <div className="flex justify-between items-center pt-4">
            <div>
              <p className="font-medium transition-colors">{t('childrenLabel')}</p>
              <p className="text-sm text-gray-500 transition-colors">{t('childrenDescription')}</p>
            </div>
            <div className="flex items-center gap-2">
              <button
