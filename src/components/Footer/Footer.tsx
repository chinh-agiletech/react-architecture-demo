    ...
    <footer className="bg-[#454545] text-white py-12 mt-4">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <div className="text-sm">
                <h4 className="font-medium">{t("companyName")}</h4>
                <p>
                  {t("companyFullName", {
                    default: "CÔNG TY CỔ PHẦN ĐT & QL TÀI SẢN PCLAND",
                  })}
                </p>
              </div>
              <Link href="/member" className="text-sm hover:underline">
                {t("aboutXHotelMember", {
                  default: "Về X Hotel Member",
                })}
              </Link>
              <Link href="/about" className="text-sm hover:underline">
                {t("aboutXHotel", { default: "Về X Hotel" })}
              </Link>
              <Link href="/news" className="text-sm hover:underline">
                {t("news", { default: "X News" })}
              </Link>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 uppercase">
              {t("support", { default: "Hỗ trợ" })}
            </h3>
            <div className="flex flex-col space-y-3">
              <Link href="/terms" className="text-sm hover:underline">
                {t("terms", { default: "Chính sách và điều khoản" })}
              </Link>
              <Link href="/general-rules" className="text-sm hover:underline">
                {t("generalRules", { default: "Quy định chung" })}
              </Link>
              <Link href="/privacy-policy" className="text-sm hover:underline">
                {t("privacyPolicy", { default: "Chính sách bảo mật" })}
              </Link>
              <Link href="/booking-policy" className="text-sm hover:underline">
                {t("bookingPolicy", {
                  default: "Chính sách giao và nhận phòng",
                })}
              </Link>
              <Link
              ...
              >
                {t("cancellationPolicy", {
                  default: "Chính sách đổi, trả phòng và hoàn tiền",
                })}
              </Link>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <p className="text-sm">
                {t("address", {
                  default: "Địa chỉ: Xã Tây Phương, Hà Nội",
                })}
              </p>
              <p className="text-sm">
                {t("email", { default: "Email" })}:{" "}
                <a href="mailto:info@xhotel.vn" className="hover:underline">
                  info@xhotel.vn
                </a>
              </p>
            </div>
