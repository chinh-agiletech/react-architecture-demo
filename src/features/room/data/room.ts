 ...
 export const rooms: Room[] = [
    {
      id: "1",
      name: "XHome VIP",
      location: "XHOME THÁI NGUYÊN",
      image: "/can-ho-khach-san-tai-thai-nguyen-phong-xhome-vip-1.webp",
      price: 920000,
      amenities: [
        ...
        {
        name: "Máy giặt",
        icon: "M4 2h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm8 6a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm-4-2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm3 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"
        },
        ...
        { name: "Điều hòa", icon: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" },
      ]
    },
    {
      id: "2",
      name: "XHome Premium",
      location: "XHOME THÁI NGUYÊN",
      image: "khac-san-tinh-yeu-o-thai-nguyen-phong-tan-huong-1.webp",
      price: 850000,
      amenities: [
        { name: "Smart TV", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
        {
