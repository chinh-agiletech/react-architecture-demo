...
import SelectComponent from "../../../components/Ui/SelectCustom/SelectCustom";
          ...
          <div className="grid grid-cols-1 gap-6 bg-[#fcfcfc]">
            {rooms.map((room) => (
              <RoomCard
                ...
                brand_type={
                  room.hotel?.brand_type || room.room_type?.brand_type
                }
              />
            ))}
          </div>
          ...
          <div className="space-y-2">
            {priceOptions.map((option) => (
              <div key={option.id} className="flex items-center py-1">
                ...
                />
                <label htmlFor={`price-${option.id}`} className="text-gray-700">
                  {option.label}
                </label>
              </div>
            ))}
